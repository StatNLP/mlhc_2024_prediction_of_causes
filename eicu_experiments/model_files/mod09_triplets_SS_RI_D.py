...
class StratsModel(nn.Module):
    ...
    def forward(self, demo, times, values, varis, trainn=False, tgt=torch.zeros(batch_size, 1, V).cuda(), schedule=True, probability=0.5, deterministic=False):
...
# %%
lr, batch_size, samples_per_epoch, patience = 0.0005, 16, 102400, 6
...
fore_savepath = 'eicu_24h_strats_no_interp_with_ss_fore_strats_ims_sampling_detach_schedule_random_new.pytorch'
