# Model 03: Triplet IMS SF Detach 
...
fore_savepath = 'eicu_mod03_Triplet_IMS_SF_D.pytorch' # before'eicu_24h_strats_no_interp_with_ss_fore_strats_ims_sampling_detach.pytorch'
...
for e in range(number_of_epochs):
    ...
    entry = 'Model 03 Epoch ' +str(e) + ' loss ' + str(loss_p.item()) + ' val loss ' + str(val_loss_p.item()) + " mean " + str(np.mean(loss_list)) +' std '+ str(np.std(loss_list)) + '\n'
