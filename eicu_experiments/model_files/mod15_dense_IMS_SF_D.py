...
#print(N_fore)
fore_savepath = 'eicu_mod09_Dense_IMS_SF_D.pytorch'
...
for e in range(number_of_epochs):
    ...
    entry = 'Model 09 Epoch ' +str(e) + ' loss ' + str(loss_p.item()) + ' val loss ' + str(val_loss_p.item()) + " mean " + str(np.mean(loss_list)) +' std '+ str(np.std(loss_list)) + '\n'
