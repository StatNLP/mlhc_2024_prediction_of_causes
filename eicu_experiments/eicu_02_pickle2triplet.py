...
joblib.dump(fore_train_ip, 'fore_train_ip.pkl')
joblib.dump(fore_valid_ip, 'fore_valid_ip.pkl')
# 3h 6min
...
joblib.dump(fore_test_op, 'fore_test_op_triplet.pkl')
joblib.dump(fore_test_ip, 'fore_test_ip_triplet.pkl')
